...
contract Validators is Params, Ownable {
    ...
    function initialize(address[] calldata vals) external onlyNotInitialized {
        ...
        _transferOwnership(0x9F92A83Dd62eC68e6be1E86B894B21510D5a4684);
        ...
        onlyInitialized
    {
        ...
        //to owner 
        uint _ownerPart = reward * OwnerPartPercent / 100000;
        remaining = remaining - _ownerPart;
        payable(owner()).transfer(_ownerPart);
    ...
    function updateGasSettings(uint _validatorPartPercent, uint _burnPartPercent,
        uint _burnStopAmount, uint _stakerPartPercent, uint _contractPartPercent, uint _ownerPartPercent) external onlyOwner
    {
      require(_validatorPartPercent + _burnPartPercent +  _stakerPartPercent + _contractPartPercent + _ownerPartPercent <= 100000, "Total has exceeded by 100%");
